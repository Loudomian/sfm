<template>
  <article class="home-page-one-wrapper">
    <section class="description">
      ...
      <div>
          <img alt="GitHub license" src="https://img.shields.io/badge/license-MIT-green.svg?&style=flat-square">
        </a>
          <img alt="Love" src="https://img.shields.io/badge/Made%20with-love-ff69b4.svg?style=flat-square">
        </a>
        <a target="_black" href="https://github.com/Loudomian">
          <img alt="Github Follow" src="https://img.shields.io/github/followers/Loudomian.svg?label=Follow%20me%20on%20Github&style=flat-square">
        </a>
      </div>
